...
log.debug("Parssing spritesheet")
...
while True:  # game loop
    ...
    if level['num'] == 1:
        ...
        if 27 * TILE_SIZE < player_rect.x < 33 * TILE_SIZE:
            ...
            cords = (22, 7)
        elif 31 * TILE_SIZE < player_rect.x and limitations == level['locations']['main']['limitations']:
            box_text = 'this information is enough for you to get to the exit'
            cords = (36, 7)
        elif 31 * TILE_SIZE < player_rect.x and 23 * TILE_SIZE < player_rect.y:
            box_text = 'this information is enough for you to get to the exit'
            cords = (36, 17)
        else:
            tutorial_surf = box_text = cords = None
    ...
    if show_cords:
        log.info((player_rect.x, player_rect.y))
